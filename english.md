...
+ [protocol request/response data structure (json)] (#protocol request response data structure)
   ...
   + [CMD: 8, query order information according to order ID] (#cmd-8-check order information according to order id)
   + [CMD: 9, check the transaction record according to the transaction record ID] (#cmd-9-Query the transaction record according to the transaction record id)
   + [CMD: 10, Query Transaction Information] (#cmd-10-Query Transaction Information)
   + [CMD: 11, query order based on tag] (#cmd-11-Query order based on tag)
   + [CMD: 12, check the transaction record according to the tag] (#cmd-12-Query the transaction record according to the tag)
   + [CMD: 13, Query Valid Transaction Pair List] (#cmd-13-Query Valid Transaction Pair List)
...
+ [Association of order and transaction record] (#Association of order and transaction record)
+ [Implementation of trading strategy] (#realization of trading strategy)
